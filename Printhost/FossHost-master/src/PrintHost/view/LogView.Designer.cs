namespace PrintHost.view
{
    partial class LogView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.listLog = new PrintHost.view.LogBox();
            this.switchCommandsSend = new PrintHost.view.SwitchButton();
            this.switchInfo = new PrintHost.view.SwitchButton();
            this.switchWarnings = new PrintHost.view.SwitchButton();
            this.switchErrors = new PrintHost.view.SwitchButton();
            this.switchACK = new PrintHost.view.SwitchButton();
            this.switchAutoscroll = new PrintHost.view.SwitchButton();
            ...
            this.switchCommandsSend.OnChange += new PrintHost.view.SwitchEventHandler(this.switchCommandsSend_OnChange);
            // 
            // switchInfo
            // 
            ...
            this.switchInfo.OnChange += new PrintHost.view.SwitchEventHandler(this.switchInfo_OnChange);
            // 
            // switchWarnings
            // 
            ...
            this.switchWarnings.OnChange += new PrintHost.view.SwitchEventHandler(this.switchWarnings_OnChange);
            // 
            // switchErrors
            // 
            ...
            this.switchErrors.OnChange += new PrintHost.view.SwitchEventHandler(this.switchErrors_OnChange);
            // 
            // switchACK
            // 
            ...
            this.switchACK.OnChange += new PrintHost.view.SwitchEventHandler(this.switchACK_OnChange);
            // 
            // switchAutoscroll
            // 
            ...
            this.switchAutoscroll.OnChange += new PrintHost.view.SwitchEventHandler(this.switchAutoscroll_OnChange);
            // 
            // LogView
            // 
