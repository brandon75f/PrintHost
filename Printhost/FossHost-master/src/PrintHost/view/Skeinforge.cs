...
*/
        ...
        private void regToForm()
        {
            ...
            textSkeinforge.Text = (string)PrintKey.GetValue("SkeinforgePath", textSkeinforge.Text);
            textSkeinforgeCraft.Text = (string)PrintKey.GetValue("SkeinforgeCraftPath", textSkeinforgeCraft.Text);
            textPython.Text = (string)PrintKey.GetValue("SkeinforgePython", textPython.Text);
            textPypy.Text = (string)PrintKey.GetValue("SkeinforgePypy", textPypy.Text);
            //textExtension.Text = (string)PrintKey.GetValue("SkeinforgeExtension", textExtension.Text);
            //textPostfix.Text = (string)PrintKey.GetValue("SkeinforgePostfix", textPostfix.Text);
            textWorkingDirectory.Text = (string)PrintKey.GetValue("SkeinforgeWorkdir", textWorkingDirectory.Text);
        ...
        private void FormToReg()
        {
            ...
            PrintKey.SetValue("SkeinforgePath", textSkeinforge.Text);
            PrintKey.SetValue("SkeinforgeCraftPath", textSkeinforgeCraft.Text);
            PrintKey.SetValue("SkeinforgePython", textPython.Text);
            PrintKey.SetValue("SkeinforgePypy", textPypy.Text);
            //PrintKey.SetValue("SkeinforgeExtension", textExtension.Text);
            //PrintKey.SetValue("SkeinforgePostfix", textPostfix.Text);
            PrintKey.SetValue("SkeinforgeWorkdir", textWorkingDirectory.Text);
        }
