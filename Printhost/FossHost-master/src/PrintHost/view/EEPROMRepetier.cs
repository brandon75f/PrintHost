...
{
    public partial class EEPROMPrint : Form
    {
        ...
        private void EEPROMPrint_FormClosing(object sender, FormClosingEventArgs e)
        {
            RegMemory.StoreWindowPos("eepromWindow", this, false, false);
        }

        private void EEPROMPrint_Activated(object sender, EventArgs e)
        {
            if (reinit)
            {
                reinit = false;
