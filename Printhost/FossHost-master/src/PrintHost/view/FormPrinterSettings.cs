...
namespace PrintHost.view
{
    ...
    public partial class FormPrinterSettings : Form
    {
        ...
        public FormPrinterSettings()
        {
            ...
            printerKey = PrintKey.CreateSubKey("printer");
            con = Main.conn;
            conToForm();
            ...
            con.printerName = (string)PrintKey.GetValue("currentPrinter", "default");
        ...
        private void comboPrinter_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            formToCon();
            UpdateDimensions(); 
            PrintKey.SetValue("currentPrinter", comboPrinter.Text);
