...
namespace PrintHost.view
{
    ...
    public partial class PrintEditor : UserControl
    {
        ...
        public class Undo
        {
            ...
            public void DeleteSelection(PrintEditor e,int cstart,int rstart,int cend,int rend)
            {
            ...
            private void InsertString(PrintEditor e,string s)
            {
                int rstart = row;
                int cstart = col;
                int rend = selRow;
            ...
            private void EndPos(PrintEditor e, string s,out int cpos,out int rpos)
            {
                int rstart = row;
                int cstart = col;
                int rend = selRow;
            ...
            public void UndoAction(PrintEditor e)
            {
                int rstart = row;
                int cstart = col;
                int rend = selRow;
            ...
            public void RedoAction(PrintEditor e)
            {
                int rstart = row;
                int cstart = col;
                int rend = selRow;
        ...
        public class Content
        {
            ...
            PrintEditor editor = null;
            public string name;
            public int etype; // 0 = G-Code, 1 = prepend, 2 = append
            public Content(PrintEditor e, int tp, string _name)
            {
                name = _name;
                //Text = "";
    ...
    //        Text = System.IO.File.ReadAllText("d:\\arduino\\Mendel\\models\\work\\oozetest.gcode");
        ...
        private void PrintEditor_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.KeyCode)
            {
                case Keys.Down:
        ...
        private void PrintEditor_Enter(object sender, EventArgs e)
        {
            hasFocus = true;
            CreateCursor();
        }

        private void PrintEditor_Leave(object sender, EventArgs e)
        {
            hasFocus = false;
            HideCursor();
        }
        ...
        private void PrintEditor_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar >= 32)
            {
