...
namespace PrintHost.view.utils
{
    public class Slicer : IDisposable
    {
        ...
        public Slicer()
        {
            ...
            Main.slicer = this;
            ActiveSlicer = Main.printerModel.ActiveSlicer; // (Slicer.SlicerID)(int)Main.main.PrintKey.GetValue("ActiveSlicer", (int)ActiveSlicer);
        ...
        public SlicerID ActiveSlicer {
            ...
            set {
                if(value!=_ActiveSlicer) {
                    ...
                    //Main.main.PrintKey.SetValue("ActiveSlicer", (int)_ActiveSlicer);
                }
        ...
        public void Update()
        {
            string basedir = (string)Main.main.PrintKey.GetValue("installPath","");
