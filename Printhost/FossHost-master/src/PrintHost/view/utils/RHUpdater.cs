...
namespace PrintHost.view.utils
{
    public partial class RHUpdater : Form
    {
        public static string currentVersion = "0.90C";
        public static int buildVersion = 63;
        public static string newestVersion = "";
        public static int newestBuildVersion = 0;
        public static string updateText = "";
        public static bool silent = false;
        public static string downloadUrl = Custom.GetString("downloadUrl", "http://www.FossRobotics.com/download/");
        ...
        {
            Text = Trans.T("W_Print_HOST_UPDATE_CHECK");
        ...
        public static void checkForUpdates(bool silent) {
            ...
            url = "http://www.Fossrobotics.com/updates/rh/version_windows.txt";
            if (Environment.OSVersion.Platform == PlatformID.Unix)
                url = "http://www.Fossrobotics.com/updates/rh/version_linux.txt";
