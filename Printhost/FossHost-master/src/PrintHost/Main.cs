...
using PrintHost.model;
using PrintHost.view;
using PrintHost.view.utils;
using PrintHost.model.geom;
using Microsoft.Win32;
using System.Threading;
using System.Diagnostics;
using PrintHost.model;
using PrintHost.connector;
using System.Runtime.InteropServices;
using PrintHost.view.calibration;
...
namespace PrintHost
{
    ...
    public partial class Main : Form
    {
        ...
        public PrintHost.view.PrintEditor editor;
        ...
        public class JobUpdater
        {
            ...
            public void DoWork()
            {
                PrintEditor ed = Main.main.editor;
        ...
        public Main()
        {
            ...
            PrintKey = Custom.BaseKey; // Registry.CurrentUser.CreateSubKey("SOFTWARE\\Print");
            PrintKey.SetValue("installPath", Application.StartupPath);
            ...
            foreach (string s in parms)
            {
                if (lastcom == "-home")
                {
                    PrintKey.SetValue("installPath",s);
                    lastcom = "";
                    continue;
                }
        ...
        public void translate()
        {
            ...
            PrintSettingsToolStripMenuItem.Text = Trans.T("M_Print_SETTINGS");
            ...
            PrintHostHomepageToolStripMenuItem.Text = Trans.T("M_Print_HOST_HOMEPAGE");
            PrintHostDownloadPageToolStripMenuItem.Text = Trans.T("M_Print_HOST_DOWNLOAD_PAGE");
            ...
            aboutPrintHostToolStripMenuItem.Text = Trans.T("M_ABOUT_Print_HOST");
        ...
        private void testToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (conn.isPrint)
            {
                ...
                if (eepromSettings == null)
                    eepromSettings = new EEPROMPrint();
        ...
        private void aboutPrintHostToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void PrintHostHomepageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            openLink("http://www.Fossrobotics.com");
        }

        private void manualToolStripMenuItem_Click(object sender, EventArgs e)
        {
            openLink("http://www.Fossrobotics.com/documentation/Print-host/");
        }
        ...
        {
            if (conn.isMarlin || conn.isPrint || conn.isSprinter) // Activate special menus and function
            {
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            if (recalcJobPreview && jobPreviewThreadFinished)
            {
                ...
                previewArray0.AddRange(((PrintEditor.Content)editor.toolFile.Items[1]).textArray);
                previewArray1.AddRange(((PrintEditor.Content)editor.toolFile.Items[0]).textArray);
                previewArray2.AddRange(((PrintEditor.Content)editor.toolFile.Items[2]).textArray);
        ...
        public void PrintHostDownloadPageToolStripMenuItem_Click(object sender, EventArgs e)
        {
            openLink(Custom.GetString("downloadUrl","http://www.Fossrobotics.com/download/"));
        }
        ...
        {
            openLink("http://www.Fossrobotics.com/donate-or-support/");
        }
        ...
        {
            openLink(Custom.GetString("extraSupportURL", "http://www.FossRobotics.com.com"));
        }
