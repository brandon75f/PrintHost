...
namespace PrintHost.model
{
    ...
    {
        public const string PrintExtension = "repstate";
        ...
        {
            PendingPrintJob job = new PendingPrintJob(snapshot, PendingJobsDir + Path.DirectorySeparatorChar + name + "." + PrintExtension);
            job.Save();
        }
        ...
        private static string[] GetPendingJobsFiles()
        {
            try
            {
                ...
                string[] files = Directory.GetFiles(PendingJobsDir, "*." + PrintExtension);
        ...
        public static PendingPrintJob GetPendingJobWithName(string snapshotName)
        {
            try
            {
                ...
                string pendingJobFilePath = PendingJobsDir + Path.DirectorySeparatorChar + snapshotName + "." + PrintExtension;
    ...
    public class PendingPrintJob
    {
        ...
        public void Rename(string newName)
        {
            ...
            string newPath = Path.GetDirectoryName(oldPath) + Path.DirectorySeparatorChar + newName + "." + PendingPrintJobs.PrintExtension;
