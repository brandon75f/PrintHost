        ...
        public void receiveLine(GCode code)
        {
            ...
            lock (output)
            {
                if (code.hasM) switch (code.M)
                    {
                        case 115: // Firmware
                            output.AddLast("FIRMWARE_NAME:PrintVirtualPrinter FIRMWARE_URL:https://github.com/Print/Print-Firmware/ PROTOCOL_VERSION:1.0 MACHINE_TYPE:Mendel EXTRUDER_COUNT:1 Print_PROTOCOL:1");
                            //output.AddLast("FIRMWARE_NAME:Marlin FIRMWARE_URL:https://github.com/Print/Print-Firmware/ PROTOCOL_VERSION:1.0 MACHINE_TYPE:Mendel EXTRUDER_COUNT:1 Print_PROTOCOL:1");
                            break;
